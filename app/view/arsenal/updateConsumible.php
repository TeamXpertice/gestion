...
<body>
    ...
    <div class="main-content">
        <div class="container mt-5">
            ...
            <form action="/gestion/ArsenalController.php?action=updateConsumible" method="POST">
                <input type="hidden" name="id" value="<?php echo htmlspecialchars($consumible['id']); ?>">
                <div class="form-group">
                    <label for="nombre">Nombre</label>
                    <input type="text" name="nombre" id="nombre" class="form-control" value="<?php echo htmlspecialchars($consumible['nombre']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="descripcion">Descripción</label>
                    <textarea name="descripcion" id="descripcion" class="form-control" required><?php echo htmlspecialchars($consumible['descripcion']); ?></textarea>
                </div>
