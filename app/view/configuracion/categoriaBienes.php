<div class="col-sm-6">
    <h5 class="mb-0">Gestión de Categorías de Bienes</h5>
</div>
<div class="col-sm-6">
    <ol class="breadcrumb float-sm-end">
        <li class="breadcrumb-item"><a href="/gestion/app/controller/DashboardController.php?action=showDashboard">Inicio</a></li>
        <li class="breadcrumb-item active" aria-current="page">Categorías de Bienes</li>
    </ol>
</div>
...
<div class="app-content">
    ...
    onclick="eliminarCategoriaBien(this)"
    data-id="<?= $categoria['id'] ?>"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formEditarCategoria" action="/gestion/app/controller/CategoriaBienesController.php?action=editarCategoria" method="POST">
